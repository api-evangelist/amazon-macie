...
**APIs.json:** [https://raw.githubusercontent.com/api-evangelist/amazon-macie/refs/heads/main/apis.yml](https://raw.githubusercontent.com/api-evangelist/amazon-macie/refs/heads/main/apis.yml)
...
- **Base URL:** `https://macie2.amazonaws.com`
...
- [OpenAPI](openapi/amazon-macie-openapi-original.yaml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [Getting Started](https://aws.amazon.com/macie/getting-started/)
- [Pricing](https://aws.amazon.com/macie/pricing/)
- [F A Q](https://aws.amazon.com/macie/faq/)
- [JSON Schema](json-schema/amazon-macie-finding-schema.json) — [JSON Schema](https://json-schema.org/specification)
- [JSON Structure](json-structure/amazon-macie-finding-structure.json)
- [JSON-LD](json-ld/amazon-macie-context.jsonld) — [JSON-LD](https://www.w3.org/TR/json-ld11/)
...
- [Spectral Rules](rules/amazon-macie-spectral-rules.yml)
